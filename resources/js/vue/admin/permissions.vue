                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-between align-items-start align-items-sm-center mb-3">
                        ...
                        <div>
                            <button class="btn btn-primary btn-sm w-100 w-sm-auto mt-2 mt-sm-0"
                                @click="nuevoPermiso()">
                                <i class="ti ti-clipboard-check"></i> Nuevo Permiso
                            </button>
                        </div>
                    </div>
                    ...
                    <EasyDataTable
                        ...
                        <template #item-opciones="{ id }">
                            <div class="dropdown">
                                ...
                                <li>
                                    <a class="dropdown-item" href="#" @click.prevent="deleteP(id)">
    ...
    data() {
        ...
        return {
            ...
            headers: [
                ...
                { text: "DESCRIPCIÓN", value: "descripcion", sortable: true, width: 600 },
    ...
    methods: {
        ...
        async get() {
            try {
                ...
                const response = await this.$axios.get('/Permiso/get');
        ...
        async create() {
            ...
            try {
                ...
                const response = await this.$axios.post('/Permiso/create', data);
                if (response.data.status) {
                    this.get();
                    this.cerrarmodal();
                    this.resetForm();
        ...
        async edit(id) {
            ...
            try {
                ...
                const response = await this.$axios.get(`/Permiso/edit/${id}`);

                if (response.data.status) {
                    this.idpermiso = response.data.data.id;
        ...
        async update() {
            ...
            try {
                ...
                const response = await this.$axios.put(`/Permiso/update/${this.idpermiso}`, data);
        ...
        async updateStatus(id) {
            ...
            try {
                ...
                if (confirmChange.isConfirmed) {
                    ...
                    const response = await this.$axios.put(`/Permiso/updateStatus/${id}`);
        ...
        async deleteP(id) {
            ...
            try {
                ...
                if (confirmDelete.isConfirmed) {
                    ...
                    const response = await this.$axios.delete(`/Permiso/delete/${id}`);
        ...
        /* Métodos para modal de Permisos de Inscripción */
        nuevoPermiso() {
            this.resetForm();
