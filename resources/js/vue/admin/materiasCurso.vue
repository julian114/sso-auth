            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Materias de Curso</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Utilerias</a></li>
                        <li class="breadcrumb-item"><a href="#">Catálogos</a></li>
                        <li class="breadcrumb-item" aria-current="page">Materias de Curso</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Lista de Materias de Curso</h5>
                </div>
                    ...
                    <EasyDataTable
                        ...
                        <template #item-opciones="{ id }">
                            <div class="dropdown">
                                ...
                                <li>
                                    <a class="dropdown-item" href="#" @click.prevent="deleteMateria(id)">
    ...
    methods: {
        ...
        async get() {
            try {
                ...
                const response = await this.$axios.get('/MateriasCurso/get');
        ...
        async create() {
            ...
            try {
                ...
                const response = await this.$axios.post('/MateriasCurso/create', data);
                if (response.data.status) {
                    this.get();
                    this.cerrarmodal();
                    this.resetForm();
        ...
        async edit(id) {
            try {
                ...
                this.incrementarCarga();
                this.modalTitle = "Editar Materia de Curso";
                this.flag = 1;

                const response = await this.$axios.get(`/MateriasCurso/edit/${id}`);

                if (response.data.status) {
                    this.idmateria = response.data.data.id;
                ...
                if (error.response && error.response.data && error.response.data.message) {
                    ...
                    this.$swal.fire('Error', 'Se produjo un error al editar la materia.', 'error');
                }
            } finally {
                this.decrementarCarga();
            }
        ...
        async update() {
            ...
            try {
                ...
                const response = await this.$axios.put(`/MateriasCurso/update/${this.idmateria}`, data);
        ...
        async updateStatus(id) {
            ...
            try {
                ...
                if (confirmChange.isConfirmed) {
                    ...
                    const response = await this.$axios.put(`/MateriasCurso/updateStatus/${id}`);
        ...
        async deleteMateria(id) {
            ...
            try {
                ...
                if (confirmDelete.isConfirmed) {
                    ...
                    const response = await this.$axios.delete(`/MateriasCurso/delete/${id}`);
        ...
        /* Métodos para modal de Materias de Curso */
        nuevaMateria() {
            this.resetForm();
            this.modalTitle = "Nueva Materia de Curso";
            this.flag = 0;
            this.abrirmodal();
        },
