            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Municipios</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <EasyDataTable
                        ...
                        <template #item-opciones="{ id }">
                            <div class="dropdown">
                                ...
                                <li>
                                    <a class="dropdown-item" href="#" @click.prevent="deleteMunicipio(id)">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-floating">
                                    <select v-model="estado_id_modal" class="form-select" :class="{ 'is-invalid': errors.estado_id_modal }" id="estado_id_modal">
                                        <option v-for="estado in estados" :key="estado.id" :value="estado.id">
                                            {{ estado.nombre }}
                                        </option>
                                    </select>
                                    <label>Estado</label>
                                    <div v-if="errors.estado_id_modal" class="text-danger mt-1 d-block small">Seleccione un estado</div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-3">
                                <div class="form-floating">
...
export default {
    ...
    data() {
        ...
        return {
            ...
            headers: [
                ...
                { text: "MUNICIPIO", value: "nombre", sortable: true },
    ...
    computed: {
        municipiosFiltrados() {
            ...
            return this.municipios.filter(item => {
    ...
    methods: {
        ...
        async getEstados() {
            try {
                ...
                const response = await this.$axios.get('/Municipios/getEstados');
                ...
                if (error.response && error.response.data && error.response.data.message) {
                    ...
                    this.$swal.fire('Error', 'Se produjo un error al obtener los estados.', 'error');
                }
            } finally {
        ...
        async get() {
            try {
                this.incrementarCarga();
                const response = await this.$axios.get('/Municipios/get');
                if (response.data.status) {
        ...
        async create() {
            ...
            try {
                ...
                const response = await this.$axios.post('/Municipios/create', data);
                if (response.data.status) {
                    this.get();
                    this.cerrarmodal();
                    this.resetForm();
        ...
        async edit(id) {
            try {
                ...
                this.incrementarCarga();
                this.modalTitle = "Editar Municipio";
                this.flag = 1;

                const response = await this.$axios.get(`/Municipios/edit/${id}`);

                if (response.data.status) {
                    this.idmunicipio = response.data.data.id;
                ...
                if (error.response && error.response.data && error.response.data.message) {
                    ...
                    this.$swal.fire('Error', 'Se produjo un error al editar el municipio.', 'error');
                }
            } finally {
                this.decrementarCarga();
            }
        ...
        async update() {
            ...
            try {
                ...
                const response = await this.$axios.put(`/Municipios/update/${this.idmunicipio}`, data);
        ...
        async deleteMunicipio(id) {
            ...
            try {
                ...
                if (confirmDelete.isConfirmed) {
                    ...
                    const response = await this.$axios.delete(`/Municipios/delete/${id}`);
        ...
        /* Métodos para modal de Municipios */
        nuevoMunicipio() {
            this.resetForm();
            this.modalTitle = "Nuevo Municipio";
            this.flag = 0;
            this.abrirmodal();
        },
