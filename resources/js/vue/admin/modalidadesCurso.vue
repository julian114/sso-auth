            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Modalidades de Curso</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Utilerias</a></li>
                        <li class="breadcrumb-item"><a href="#">Catálogos</a></li>
                        <li class="breadcrumb-item" aria-current="page">Modalidades de Curso</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Lista de Modalidades de Curso</h5>
                </div>
                    ...
                    <EasyDataTable
                        ...
                        <template #item-opciones="{ id }">
                            <div class="dropdown">
                                ...
                                <li>
                                    <a class="dropdown-item" href="#" @click.prevent="deleteModalidad(id)">
...
export default {
    ...
    computed: {
        modalidadesFiltradas() {
            ...
            if (!query) return this.modalidades;
    ...
    methods: {
        ...
        async get() {
            try {
                ...
                const response = await this.$axios.get('/ModalidadesCurso/get');
        ...
        async create() {
            ...
            try {
                ...
                const response = await this.$axios.post('/ModalidadesCurso/create', data);
                if (response.data.status) {
                    this.get();
                    this.cerrarmodal();
                    this.resetForm();
        ...
        async edit(id) {
            try {
                ...
                this.incrementarCarga();
                this.modalTitle = "Editar Modalidad de Curso";
                this.flag = 1;

                const response = await this.$axios.get(`/ModalidadesCurso/edit/${id}`);

                if (response.data.status) {
                    this.idmodalidad = response.data.data.id;
                ...
                if (error.response && error.response.data && error.response.data.message) {
                    ...
                    this.$swal.fire('Error', 'Se produjo un error al editar la modalidad.', 'error');
                }
            } finally {
                this.decrementarCarga();
            }
        ...
        async update() {
            ...
            try {
                ...
                const response = await this.$axios.put(`/ModalidadesCurso/update/${this.idmodalidad}`, data);
        ...
        async updateStatus(id) {
            ...
            try {
                ...
                if (confirmChange.isConfirmed) {
                    ...
                    const response = await this.$axios.put(`/ModalidadesCurso/updateStatus/${id}`);
        ...
        async deleteModalidad(id) {
            ...
            try {
                ...
                if (confirmDelete.isConfirmed) {
                    ...
                    const response = await this.$axios.delete(`/ModalidadesCurso/delete/${id}`);
        ...
        /* Métodos para modal de Modalidades de Curso */
        nuevaModalidad() {
            this.resetForm();
            this.modalTitle = "Nueva Modalidad de Curso";
            this.flag = 0;
            this.abrirmodal();
        },
