            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Estados de Inscripción</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Utilerias</a></li>
                        <li class="breadcrumb-item"><a href="#">Catálogos</a></li>
                        <li class="breadcrumb-item" aria-current="page">Estados de Inscripción</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Lista de estados de Inscripción</h5>
                </div>
                    ...
                    <EasyDataTable
                        ...
                        <template #item-opciones="{ id }">
                            <div class="dropdown">
                                ...
                                <li>
                                    <a class="dropdown-item" href="#" @click.prevent="deleteEI(id)">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-floating">
                                    <VField name="estado_modal" type="text" class="form-control" :class="{ 'is-invalid': errors.estado_modal }"
                                            placeholder="#" id="estado_modal" v-model="estado_modal" rules="required" />
                                    <label>Nombre del Estado</label>
                                    <VErrorMessage name="estado_modal" class="text-danger mt-1 d-block small" />
                                </div>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            descripcion_modal: "",
            headers: [
                { text: "TIPO DE ESTADO", value: "estado", sortable: true },
    ...
    methods: {
        ...
        async get() {
            try {
                ...
                const response = await this.$axios.get('/EstadosInscripcion/get');
        ...
        async create() {
            ...
            try {
                ...
                const response = await this.$axios.post('/EstadosInscripcion/create', data);
                if (response.data.status) {
                    this.get();
                    this.cerrarmodal();
                    this.resetForm();
        ...
        async edit(id) {
            try {
                ...
                this.incrementarCarga();
                this.modalTitle = "Editar Estado de Inscripción";
                this.flag = 1;

                const response = await this.$axios.get(`/EstadosInscripcion/edit/${id}`);

                if (response.data.status) {
                    this.idestado = response.data.data.id;
                    this.estado_modal = response.data.data.estado;
        ...
        async update() {
            ...
            try {
                ...
                const response = await this.$axios.put(`/EstadosInscripcion/update/${this.idestado}`, data);
        ...
        async updateStatus(id) {
            ...
            try {
                ...
                if (confirmChange.isConfirmed) {
                    ...
                    const response = await this.$axios.put(`/EstadosInscripcion/updateStatus/${id}`);
        ...
        async deleteEI(id) {
            ...
            try {
                ...
                if (confirmDelete.isConfirmed) {
                    ...
                    const response = await this.$axios.delete(`/EstadosInscripcion/delete/${id}`);
        ...
        nuevoEstado() {
            this.resetForm();
            this.modalTitle = "Nuevo Estado de Inscripción";
            this.flag = 0;
            this.abrirmodal();
        },
